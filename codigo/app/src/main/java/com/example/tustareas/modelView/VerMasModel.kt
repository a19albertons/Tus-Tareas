 ...
 * @param repository El repositorio de ver mas
...
class VerMasModel
    ...
    constructor(
         ...
         * @author Alberto Noceda <a19albertons@iessanclemente.net>
         */
        fun obtenerTareasTerminanDiaEspecificoConFiltro(): LiveData<List<Tarea>> =
            textoVerMas.switchMap { texto ->
         ...
         * @author Alberto Noceda <a19albertons@iessanclemente.net>
         */
        fun obtenerTareasRetrasadasConFiltro(): LiveData<List<Tarea>> =
            textoVerMas.switchMap { texto ->
         ...
         * @author Alberto Noceda <a19albertons@iessanclemente.net>
         */
        fun obtenerTareasProximasConFiltro(): LiveData<List<Tarea>> =
            textoVerMas.switchMap { texto ->
