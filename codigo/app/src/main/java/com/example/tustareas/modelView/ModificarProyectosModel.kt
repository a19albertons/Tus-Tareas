...
class ModificarProyectosModel @Inject constructor(
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun observarProyectoDTO() : LiveData<ProyectoDTO> {
        return proyectoDTO
    }
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun obtenerTareasDelProyecto() : List<Tarea> {
        return proyectoDTO.value!!.tareas
    }
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun obtenerEtiquetasDelProyecto() : List<Etiqueta> {
        return proyectoDTO.value!!.etiquetas
    }
    ...
    fun anadirTareaAlProyecto(posicion: Int) {
        if (listaTareasRestante.isNotEmpty() // Lista vacia
            && posicion >= 0 && posicion < listaTareasRestante.size // Protegerse de fuera de limites
    ...
    fun anadirEtiquetaAlProyecto(posicion: Int) {
        if (listaEtiquetasRestante.isNotEmpty() // Lista vacia
            && posicion >= 0 && posicion < listaEtiquetasRestante.size // Protegerse de fuera de limites
    ...
    fun tituloDialogo() : Int {
        return if (proyectoDTO.value!!.proyecto.id == 0) {
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun guardarYModificarProyecto(nombre: String, descripcion: String) {
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun observarMensajeError() : LiveData<Int> {
        return mensajeError
    }
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun observarResultado() : LiveData<Boolean> {
        return resultado
    }
    ...
    fun tareasRestantesProcesadas(tareas: List<Tarea>) : List<Tarea> {
        ...
        if (tareas.isEmpty()) {
            devolver = listOf(Tarea(0, getApplication<Application>().getString(R.string.no_existen_tareas), null, null, Prioridad.NO_ESTABLECIDO,
     ...
     * @author Alberto Noceda <a19albertons@iessanclemente.net>
     */
    fun obtenerEtiquetasRestantes() : LiveData<List<Etiqueta>> = listaEtiquetas.switchMap {
            texto ->
