...
class EstadisticasRepository
    ...
    constructor(
        ...
        fun obtenerCantidadTareasCompletasEntre2Fechas(
            fechaInicio: Long,
            fechaFin: Long,
        ) = estadisticasConsultas.obtenerCantidadTareasCompletasEntre2Fechas(fechaInicio, fechaFin)
        ...
        fun obtenerCantidadTareasPendientesEntre2Fechas(
            fechaInicio: Long,
            fechaFin: Long,
        ) = estadisticasConsultas.obtenerCantidadTareasPendientesEntre2Fechas(fechaInicio, fechaFin)
    }
